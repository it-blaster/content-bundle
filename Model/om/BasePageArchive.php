...
abstract class BasePageArchive extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Etfostra\\ContentBundle\\Model\\PageArchivePeer';
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = PageArchivePeer::ACTIVE;
        }
    ...
    public function setModule($v)
    {
        ...
        if ($this->module !== $v) {
            $this->module = $v;
            $this->modifiedColumns[] = PageArchivePeer::MODULE;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PageArchivePeer::SLUG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->module = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 12; // 12 = PageArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PageArchivePeer::ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`active`';
        }
        if ($this->isColumnModified(PageArchivePeer::MODULE)) {
        ...
        if ($this->isColumnModified(PageArchivePeer::SLUG)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setModule($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PageArchivePeer::ACTIVE)) $criteria->add(PageArchivePeer::ACTIVE, $this->active);
        if ($this->isColumnModified(PageArchivePeer::MODULE)) $criteria->add(PageArchivePeer::MODULE, $this->module);
        ...
        if ($this->isColumnModified(PageArchivePeer::SLUG)) $criteria->add(PageArchivePeer::SLUG, $this->slug);
